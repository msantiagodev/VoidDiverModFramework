local QUEST_ID = 811501
local START_NPC = "핌핌"
local START_TITLE = "<Key:LLoungeQ_811501_START_TITLE> 무형의 지평선"
...
function OnNotCompletedDialog()
	...
	LuaApi:ShowSystemToastText("<Key:LLoungeQ_811501_4001>목표 완료: 보상이 더스터에게 지급되었습니다.")
