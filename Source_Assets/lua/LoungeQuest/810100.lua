local QUEST_ID = 810100
local START_NPC = "루카"
local START_TITLE = "<Key:LLoungeQ_810100_START_TITLE> 사이코패스 교화법"
...
function OnNotCompletedDialog()
	...
	MDSay("비움", "De", "루카2", "De", "비움", "De", "루카2", 	"<Key:LLoungeQ_810100_3001>오, 정말 구해오셨군요. 감사합니다.")
	await(LuaApi:CloseDialogAsync())	
	
	LuaApi:RemoveItem(QUEST_ITEM_ID, QUEST_ITEM_COUNT)
	LuaApi:GiveEquipmentToStorage(REWARD_ITEM_ID, REWARD_ITEM_COUNT)	
	LuaApi:ShowSystemToastText("<Key:LLoungeQ_810100_4001>목표 완료: 보상이 더스터에게 지급되었습니다.")
